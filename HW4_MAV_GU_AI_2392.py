...
print("Ставка в часах: ", y)
print("Премия: ", z)
print(f'Заработная плата составляет: {zp(int(x), int(y), int(z))}')
...
lst2 = [lst1[x] for x in range(1, len(lst1)) if lst1[x] > lst1[x-1] ]
print(lst2)
...
lst2 = [x for x in lst1 if lst1.count(x) == 1] #count - считает сколько раз встретился элемент в листе.
print(lst2)
...
lst1 = [x for x in range(100, 1001) if x % 2 == 0]
#print(lst1)
comp = reduce(lambda x,y: x*y, lst1)
print(comp)
...
# cycle() модуля itertools. Обратите внимание, что создаваемый цикл не должен быть бесконечным. Предусмотрите условие его завершения. 
